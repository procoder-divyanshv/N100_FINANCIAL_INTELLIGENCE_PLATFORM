...
def generate_analyst_guide():
    ...
    story = [
        ...
        Paragraph("2. Live Cloud Deployments", h2_style),
        Paragraph("• <b>Frontend Dashboard (Streamlit Cloud):</b> <font color='blue'>https://n100financialintelligenceplatform-9kqrcgnirnyoseylf8ztw8.streamlit.app/</font><br/>"
                  "• <b>Backend REST API (Render):</b> <font color='blue'>https://n100-financial-intelligence-platform-api.onrender.com/docs</font>", body_style),
        
        Paragraph("3. Streamlit Dashboard Navigation", h2_style),
        Paragraph("• <b>Home:</b> Macro-level market overview, index KPI summaries, and sector distribution charts.<br/>"
                  "• <b>Profile:</b> Deep dive into individual company balance sheets, ROCE/ROE trajectories, and P&L histories.<br/>"
                  "• <b>Screener:</b> Custom multi-factor screening using real-time metric sliders and financial preset filters.<br/>"
                  "• <b>Peers:</b> Industry group peer benchmarking and interactive multi-axis radar comparison charts.<br/>"
        ...
        Paragraph("4. Generating & Downloading PDF Tearsheets", h2_style),
        Paragraph("Users can navigate to the <b>Reports</b> module inside the dashboard to instantly preview and download programmatically compiled 2-page company tearsheets and 11 sector intelligence summaries generated via ReportLab.", body_style),
        
        Paragraph("5. FastAPI REST API & Example cURL Commands", h2_style),
        Paragraph("The backend server runs on FastAPI and exposes 16 documented endpoints. Interactive API documentation is available at <font color='blue'>https://n100-financial-intelligence-platform-api.onrender.com/docs</font>.", body_style),
        Paragraph("<b>Health Check:</b><br/>curl -X GET \"https://n100-financial-intelligence-platform-api.onrender.com/api/v1/health\"", code_style),
        Paragraph("<b>Fetch All Companies:</b><br/>curl -X GET \"https://n100-financial-intelligence-platform-api.onrender.com/api/v1/companies?sector=IT\"", code_style),
        Paragraph("<b>Download Company Tearsheet PDF:</b><br/>curl -X GET \"https://n100-financial-intelligence-platform-api.onrender.com/api/v1/companies/INFY/tearsheet\" --output infy_tearsheet.pdf", code_style),
        
        Paragraph("6. Troubleshooting & Support", h2_style),
        Paragraph("• <i>Port Conflicts:</i> Ensure local ports are free if testing backend changes locally.<br/>"
                  "• <i>Missing Data Errors:</i> Run the ETL ingestion script and clustering module (`python src/analytics/clustering.py`) if local artifacts are missing.", body_style)
    ]
    
    doc.build(story, canvasmaker=DocNumberedCanvas)
    print("✅ Generated docs/analyst_guide.pdf with full frontend & backend deployment links")
...
def generate_acceptance_checklist():
    ...
    story.append(Paragraph("<b>Final Sign-Off:</b> Verified and Approved.", body_style))
